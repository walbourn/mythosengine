...
void vngo_ttriangle8 (VngoVport *vp,VngoPoint2 *pts, VngoTextureInfo *ttex)
{
    VngoTriangle    tri;
    dword           stepped=0;
    long            dy;
...
void vngo_zttriangle8 (VngoVport *vp,VngoPoint2 *pts, VngoTextureInfo *ttex)
{
    VngoTriangle    tri;
    dword           stepped=0;
    long            dy;
...
void vngo_tgtriangle8 (VngoVport *vp,VngoPoint2 *pts, VngoTextureInfo *ttex)
{
    VngoTriangle    tri;
    dword           stepped=0;
    long            dy;
...
void vngo_ztgtriangle8 (VngoVport *vp,VngoPoint2 *pts, VngoTextureInfo *ttex)
{
    VngoTriangle    tri;
    dword           stepped=0;
    long            dy;
